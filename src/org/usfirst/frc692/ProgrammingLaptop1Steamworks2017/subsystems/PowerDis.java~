 ...
 *
 */
public class PowerDis extends Subsystem {
    ...
    private final PowerDistributionPanel powerDistributionPanel1 = RobotMap.powerDisPowerDistributionPanel1;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
    	...
    	RobotMap.powerDisPowerDistributionPanel1.clearStickyFaults();
    }
