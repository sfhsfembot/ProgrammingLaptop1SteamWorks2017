 ...
 *
 */
public class BottomLimitSwitch extends Command {
...
//    	Robot.dumpTruck.screwUp();
    ...
    protected void execute() {
    	if(Robot.dumpTruck.upperLimitSwitch())
    	{
    		...
    		Robot.dumpTruck.setDumpTruckMovingDown();
    		System.out.println("bottom limit switch activated");
    ...
    protected void interrupted() {
    	while(Robot.dumpTruck.isMovingDown() && !Robot.dumpTruck.lowerLimitSwitch())
    	{
    		Robot.dumpTruck.screwReset();
    		System.out.println("Going up to lower limit switch!");
    	}
    	end();
    }
}
