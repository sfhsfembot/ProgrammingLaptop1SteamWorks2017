...
public class RobotMap {
    ...
    public static DigitalInput dumpTruckDownStop;
    public static DigitalInput dumpTruckUpStop;
    ...
    public static DoubleSolenoid climberClimberSolenoid;
    public static SpeedController climberClimber;
    public static PowerDistributionPanel powerDisPowerDistributionPanel1;
    ...
    public static void init() {
        ...
        dumpTruckDownStop = new DigitalInput(1);
        LiveWindow.addSensor("DumpTruck", "DownStop", dumpTruckDownStop);
        
        dumpTruckUpStop = new DigitalInput(0);
        LiveWindow.addSensor("DumpTruck", "UpStop", dumpTruckUpStop);
        
        dumpTruckDumpTruckCorkscrewMotor = new VictorSP(7);
        LiveWindow.addActuator("DumpTruck", "DumpTruckCorkscrewMotor", (VictorSP) dumpTruckDumpTruckCorkscrewMotor);
        
        gearPistonGearSolenoid = new DoubleSolenoid(0, 2, 3);
        LiveWindow.addActuator("GearPiston", "GearSolenoid", gearPistonGearSolenoid);
        
        pneumaticsCompressor = new Compressor(0);
        
        
        climberClimberSolenoid = new DoubleSolenoid(0, 4, 5);
        LiveWindow.addActuator("Climber", "ClimberSolenoid", climberClimberSolenoid);
        
        climberClimber = new VictorSP(6);
        LiveWindow.addActuator("Climber", "Climber", (VictorSP) climberClimber);
        
        powerDisPowerDistributionPanel1 = new PowerDistributionPanel(1);
        LiveWindow.addSensor("PowerDis", "PowerDistributionPanel 1", powerDisPowerDistributionPanel1);
